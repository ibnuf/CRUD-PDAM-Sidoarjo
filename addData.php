...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">PDAM DELTA TIRTA</a>
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control w-50" id="tgl_lahir" placeholder="Masukkan Tanggal Lahir" name="tgl_lahir" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="id_ruangan" class="form-label">ID Ruangan</label>
                        <input type="number" class="form-control w-50" id="id_ruangan" placeholder="Masukkan ID Ruangan" name="id_ruangan" autocomplete="off" required>
                    </div>
