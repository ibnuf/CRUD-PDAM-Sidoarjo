...
$siswa = query("SELECT * FROM pegawai ORDER BY nip DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Pegawai PDAM Delta Tirta</h3>
                <hr>
				<div class="row my-2">
            <div class="col-md">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Pegawai</h5>
