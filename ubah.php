...
$siswa = query("SELECT * FROM pegawai WHERE nip = $nip")[0];
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nip" value="<?= $siswa['nip']; ?>" name="nip" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="alamat" value="<?= $siswa['alamat']; ?>" name="alamat" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="id_ruangan" value="<?= $siswa['id_ruangan']; ?>" name="id_ruangan" autocomplete="off" required>
                    </div>
                    <hr>
